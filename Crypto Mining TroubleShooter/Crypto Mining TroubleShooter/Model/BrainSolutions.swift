...
struct Brain {
    ...
    let solutions = [
        ...
        Solution(title: "Does your rig mines crypto? Confirm your ethereum address is correct on the miner.  ", choice1: "Yes! 👍", choice1Destination: 3, choice2: "No! 👎", choice2Destination: 4),
        ...
        Solution(title: "Does your rig mines at optimal hashrate? You can check if your rig mines at optimal speeds on retrowhale.ca/hashrate", choice1: "Yes! 👍", choice1Destination: 7, choice2: "No! 👎", choice2Destination: 5),
        ...
        Solution(title: "I am glad that your rig is up and running! If you still have more issues you can always contact to me at: deniz@retrowhale.ca", choice1: "The", choice1Destination: 9, choice2: "End", choice2Destination: 9),
        Solution(title: "I am sorry to hear that your rig is not mining well. I am always ready to help, you can reach me at: deniz@retrowhale.ca", choice1: "The", choice1Destination: 9, choice2: "End", choice2Destination: 9),
        Solution(title: "That's the end of this version of the app. Hope it helped you somehow. : )", choice1: "The", choice1Destination: 9, choice2: "End", choice2Destination: 9),
